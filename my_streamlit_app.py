...
st.header('SOCIAL STREAMING', divider='rainbow')
st.header('BIENVENUE SUR SOCIAL STREAMING, VOTRE AMI POUR LA VIE :sunglasses:')

df_final = pd.read_csv(r'/Users/swell/Documents/test_streamlit/df_final/Machine Learning/df_final_ML.csv')
df_final.drop(columns = 'Unnamed: 0', inplace = True )

url = pd.read_csv(r'/Users/swell/Desktop/TMDB/df_hugo_max-2.csv') # Final TMBD
acteur_realisateur = pd.read_csv(r'/Users/swell/Desktop/TMDB/acteur_realisateur.csv') # Personnes
...
################################### Machine Learning ###################################
    ...
    knn_model = NearestNeighbors(n_neighbors=6).fit(X)
